...
<HTML xmlns="http://www.w3.org/1999/xhtml"><HEAD><TITLE><?php echo $GLOBALS['S']['title'] ?></TITLE>
...
<?php $vn=0;$tablev=syClass("syModel")->syCache(3600)->findSql("select * from dy_ads where isshow=1 and taid='1'  order by orders desc,id desc limit 1");foreach($tablev as $v){ $v["n"]=$vn=$vn+1; $v["name"]=stripslashes($v["name"]); ?>
<IMG src="<?php echo $v['adfile'] ?>">
<?php } ?>
</DIV>
<!--END FADE IMAGE-->
</DIV>
...
<BR clear=all>
<P>说起圣培露，人们自然而然联想到美食与分享、快乐团聚与浓浓情谊。圣培露的气泡闪耀着柔和细密、令人沉醉的光泽，完美呼应着与朋友轻松聚会时的美妙时光，高雅口味映衬着独特的社交体验，美酒佳肴与欢声笑语完美交融，令人难以忘怀。</P></DIV><!--END INNER FOOTER--></DIV>
<!--END FOOTER--></DIV>
