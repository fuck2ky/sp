...
<A class=back 
href="/index.php?c=article&a=type&tid=21" onClick="javascript:history.go(-1)">返回</A>
...
<div class="video_article">
                 ...
                 <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="359" height="237">    
                                ...
                                <param name="FlashVars" value="vcastr_file=<?php echo $article['video'] ?>" />    

                                <embed src="Flvplayer.swf" allowfullscreen="true" flashvars="vcastr_file=<?php echo $article['video'] ?>" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="359" height="237"></embed>    
