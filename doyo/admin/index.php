...
class index extends syController
{
	...
	function left(){
		...
		switch($this->syArgs("l",1)){
			...
			$this->leftmenu.='<p></p>';
			$this->leftmenu.='<a href="http://wdoyo.com" target="_blank">查看官方更新</a>';
			break;
			case "funs":
			$this->lefttop='其他管理';
			...
			$this->leftmenu.='<p></p>';
			$this->leftmenu.='<a href="http://bbs.wdoyo.com/f-2-1.html" target="_blank">求助问答</a>';
			$this->leftmenu.='<a href="http://wdoyo.cn" target="_blank">域名主机</a>';
			break;
			default: 
			$this->lefttop='内容管理';
			foreach($this->m as $v){
